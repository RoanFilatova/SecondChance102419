...
namespace DataAccessLayer
{
    public class ContextDAL : IDisposable
    {
            ...
            try
            {
                switch (sec.State)
                {
                    ...
                    case
                        ...
                        //Shouldn't have to do anything further as it is open.
                        break;
                }
            }
            catch (Exception ex)
        ...
        public void RoleUpdateJust(int RoleID, string RoleName)
        {
            ...
            {
                EnsureConnected();
                using (SqlCommand command = new SqlCommand("RoleUpdateJust", sec))
                {
                    command.CommandType = System.Data.CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@RoleID", RoleID);
                    command.Parameters.AddWithValue("@RoleName", RoleName);
        ...
        public void UserUpdateJust(int UserID, string UserName, string Email, string Address, string Hash, string Salt, int RoleID)
        {
            ...
            {
                EnsureConnected();
                using (SqlCommand command = new SqlCommand("UserUpdateJust", sec))
                {
                    command.CommandType = System.Data.CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@UserID", UserID);
                    command.Parameters.AddWithValue("@UserName", UserName);
        ...
        public UserDAL UserFindByEmail(string Email)
        {
            ...
            {
                EnsureConnected();
                using (SqlCommand command = new SqlCommand("UserFindByEmail", sec))
                {
                    command.CommandType = System.Data.CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("Email", @Email);
                    using (SqlDataReader reader = command.ExecuteReader())
        ...
        public int BreedCreate(string BreedName)
        {
            ...
            try
            {
                ...
                {
                    command.CommandType = System.Data.CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@BreedID", 0);
        ...
        public void BreedDelete(int BreedID)
        {
            ...
            {
                EnsureConnected();
                using (SqlCommand command = new SqlCommand("BreedDelete", sec))
                {
                    command.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        public void BreedUpdateJust(int BreedID, string BreedName)
        {
            ...
            {
                EnsureConnected();
                using (SqlCommand command = new SqlCommand("BreedUpdateJust", sec))
                {
                    command.CommandType = System.Data.CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("BreedID", BreedID);
                    command.Parameters.AddWithValue("BreedName", BreedName);
        ...
        public List<BreedDAL> BreedGetAll(int Skip, int Take)
        {
            List<BreedDAL> proposedReturnValue = new List<BreedDAL>();
            try
            {
                EnsureConnected();
                using (SqlCommand command = new SqlCommand("BreedGetAll", sec))
                {
                    command.CommandType = System.Data.CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@skip", Skip);
                    command.Parameters.AddWithValue("@take", Take);
                    using (SqlDataReader reader = command.ExecuteReader())
                    {
                        BreedMapper bm = new BreedMapper(reader);
                        while (reader.Read())
                        {
                            BreedDAL items = bm.ToBreed(reader);
                            proposedReturnValue.Add(items);
                        }
                    }
                }
            }
        ...
        public BreedDAL BreedFindbyID(int BreedID)
        {
            BreedDAL proposedReturnValue = null;
            try
            {
                EnsureConnected();
                using (SqlCommand command = new SqlCommand("BreedFindByID", sec))
                {
                    command.CommandType = System.Data.CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@BreedID", BreedID);
                    using (SqlDataReader reader = command.ExecuteReader())
                    {
                        ...
                        while (reader.Read())
                        {
                            proposedReturnValue = bm.ToBreed(reader);
                        }
                    }
                }
            }
        ...
        public int BreedObtainCount()
        {
            int proposedReturnValue = 0;
            try
            {
                EnsureConnected();
                using (SqlCommand command = new SqlCommand("BreedObtainCount", sec))
                {
                    command.CommandType = System.Data.CommandType.StoredProcedure;
                    proposedReturnValue = (int)command.ExecuteScalar();
                }
        ...
        public int DogCreate(string Name, int BreedID, bool IsSmallBreed, bool IsDogHairless, string Medical, DateTime AdoptDate, DateTime SurrenderDate)
        {
            ...
            try
            {
                ...
                {
                    command.CommandType = System.Data.CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@DogID", 0);
                    command.Parameters.AddWithValue("@Name", Name);
                    command.Parameters.AddWithValue("@BreedID", BreedID);
                    ...
                    command.Parameters["@DogID"].Direction = System.Data.ParameterDirection.Output;
                    command.ExecuteNonQuery();
        ...
        public void DogUpdateJust(int DogID, string Name, bool IsSmallBreed, bool IsDogHairless, string Medical, DateTime AdoptDate, DateTime SurrenderDate)
        {
            ...
            {
                EnsureConnected();
                using (SqlCommand command = new SqlCommand("DogUpdateJust", sec))
                {
                    command.CommandType = System.Data.CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@DogID", DogID);
                    command.Parameters.AddWithValue("@Name", Name);
        ...
        public int UserDogsCreate(int UserID, int DogID)
        {
            ...
            {
                EnsureConnected();
                using (SqlCommand command = new SqlCommand("UserDogsCreate", sec))
                {
                    command.CommandType = System.Data.CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@UserID", UserID);
                    command.Parameters.AddWithValue("@DogID", DogID);
        ...
        public void UserDogsDelete(int UserID, int DogID)
        {
            ...
            {
                EnsureConnected();
                using (SqlCommand command = new SqlCommand("UserDogsDelete", sec))
                {
                    command.CommandType = System.Data.CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@UserID", UserID);
                    command.Parameters.AddWithValue("@DogID", DogID);
        ...
        public UserDAL GetUsersByDogID(int DogID)
        {
            UserDAL proposedRV = null;
            EnsureConnected();
            using (SqlCommand command = new SqlCommand("GetUsersByDogID", sec))
            {
                command.CommandType = System.Data.CommandType.StoredProcedure;
                command.Parameters.AddWithValue("@DogID", DogID);
                using (SqlDataReader reader = command.ExecuteReader())
